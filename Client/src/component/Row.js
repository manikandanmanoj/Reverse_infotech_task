...
export default function Row({flex,alignItems, middle, left, right, top, bottom, center, justify, style, padding, margin, color, children, ...props }) {
